...
4. [🗂️ Folder Structure](#️-folder-structure)
5. [⚙️ Environment Configuration (3-ENV Setup)](#️-environment-configuration-3-env-setup)
...
<p align="center">
  <img src="docs/erd-schema.png" alt="Database ERD Diagram" width="900"/>
</p>
